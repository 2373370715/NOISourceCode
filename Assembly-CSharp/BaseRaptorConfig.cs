...
public static class BaseRaptorConfig
{
	public static GameObject BaseRaptor(string id, string name, string desc, string anim_file, string traitId, bool is_baby, string symbolOverridePrefix = null)
	{
		...
		EntityTemplates.ExtendEntityToBasicCreature(false, gameObject, FactionManager.FactionID.Predator, traitId, navGridName, NavType.Floor, 32, 2f, "DinosaurMeat", 5f, true, false, 223.15f, 288.15f, 173.15f, 373.15f);
